//#include <Arduino.h> //descomente essa linha se usar vscode
#include <WiFi.h>
#include <RDA5807.h>
...
void IRAM_ATTR onTimer() {
  ...
  int32_t sample = 0;
  int adcVal = i2s_pop_sample(I2S_PORT, (char*)&sample, portMAX_DELAY);
  uint32_t value = map(adcVal, 0 , 4096, 0, 255);  // mapeamento para 8 bits
